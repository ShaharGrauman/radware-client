...
import SelectRole from './SelectRole2';
                ...
                <form className="ml-3" onSubmit={this.onSubmit}>
                    ...
                    <fieldset className="scheduler-border">
                        ...
                        {/* <div className="form-group ml-2">
                            ...
                            <input required type="password" name="confirmpassword" className="form-control inputpass" minLength="4" maxLength="16" placeholder="Enter again to validate" id="password"/> */}
